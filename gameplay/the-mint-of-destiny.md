...
Long answer: Every time a new NFT is made available into the game, whether it's a role, Villain, or limited edition Hero Skin, 1 of them is immediately minted and stored into the Vault. So if there is a limited Legendary skin with only 10 available, 1 is vaulted away for the Mint of Destiny owner, and only 9 are available to the public.
